function calculate(language) {
	...
	//		parameters: Form.serialize($('form_ttmini_feq')),
			parameters: 'input_k=' + document.form_ttmini_feq.input_k.value +'&input_l=' + document.form_ttmini_feq.input_l.value +'&input_f=' + document.form_ttmini_feq.input_f.value +'&mod=' + document.form_ttmini_feq.mod.value +'',
